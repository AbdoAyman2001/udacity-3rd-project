...
1. In AWS, provision a publicly available RDS database running Postgres. <http://database-2.c0hhjslnh11j.us-east-1.rds.amazonaws.com>
1. In AWS, provision a s3 bucket for hosting the uploaded files. <http://udacityabdoayman.s3-website-us-east-1.amazonaws.com>
